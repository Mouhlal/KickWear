...
<main class="w-full max-w-md mx-auto p-6">
    <div class="mt-7 bg-white border-gray-200 border rounded-xl shadow-sm ">
          ...
          <form method="POST" action="{{ route('client.login') }}">
            ...
            <div class="grid gap-y-4">
              ...
              <div class="flex items-center">
                <div class="flex">
                  <input id="remember-me" name="remember-me" type="checkbox" class="shrink-0 mt-0.5 border-gray-200 border rounded text-blue-600 focus:ring-blue-500">
                </div>
                <div class="ms-3">
